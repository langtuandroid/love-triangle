...
namespace GameAnalyticsSDK.Editor
{
    public class GA_SignUp : EditorWindow
    {
        ...
        private GUIContent _lastNameLabel = new GUIContent(
            "Last name",
            "Your last name (surname)."
        );
        private GUIContent _studioNameLabel = new GUIContent(
            "Studio name",
            "Your studio's name. You can add more studios and games on the GameAnalytics website."
        );
        private GUIContent _organizationNameLabel = new GUIContent(
            "Organization name",
            "Your organization's name. You can add more studios and games under your organization on the GameAnalytics website."
        );
        private GUIContent _organizationIdentifierLabel = new GUIContent(
        ...
        private GUIContent _gameNameLabel = new GUIContent(
            "Game name",
            "Your game's name. You can add more studies and games on the GameAnalytics website."
        );
        private GUIContent _passwordConfirmLabel = new GUIContent(
            "Confirm password",
            "Your GameAnalytics user account password."
        );
        private GUIContent _emailOptInLabel = new GUIContent(
            "Subscribe to release updates, news and tips and tricks.",
        ...
        private GUIContent _emailLabel = new GUIContent(
            "Email",
            "Your GameAnalytics user account email."
        );
        private GUIContent _passwordLabel = new GUIContent(
            "Password",
        ...
        void OnGUI()
        {
            switch (TourStep)
            {
                ...
                case 0: // sign up
                    ...
                    GUILayout.Label(
                        GameAnalytics.SettingsGA.UserIcon,
                        new GUILayoutOption[] { GUILayout.Width(40), GUILayout.MaxHeight(40) }
                    );
                    GUILayout.FlexibleSpace();
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.FlexibleSpace();
                    FirstName = EditorGUILayout.TextField(
                        "",
                        FirstName,
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.FlexibleSpace();
                    LastName = EditorGUILayout.TextField(
                        "",
                        LastName,
                        GUILayout.Width(INPUT_WIDTH)
                    );
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.FlexibleSpace();
                    GameAnalytics.SettingsGA.EmailGA = EditorGUILayout.TextField(
                        "",
                        GameAnalytics.SettingsGA.EmailGA,
                        GUILayout.Width(INPUT_WIDTH)
                    );
                    GUILayout.FlexibleSpace();
                    GUILayout.EndHorizontal();
                    ...
                    GameAnalytics.SettingsGA.PasswordGA = EditorGUILayout.PasswordField(
                        "",
                        GameAnalytics.SettingsGA.PasswordGA,
                        GUILayout.Width(INPUT_WIDTH)
                    );
                    GUILayout.FlexibleSpace();
                    GUILayout.EndHorizontal();
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.FlexibleSpace();
                    PasswordConfirm = EditorGUILayout.PasswordField(
                        "",
                        PasswordConfirm,
                        GUILayout.Width(INPUT_WIDTH)
                    );
                    ...
                    GameAnalytics.SettingsGA.StudioName = EditorGUILayout.TextField(
                        "",
                        GameAnalytics.SettingsGA.StudioName,
                        GUILayout.Width(INPUT_WIDTH)
                    );
                    GUILayout.FlexibleSpace();
                    GUILayout.EndHorizontal();
                    ...
                    GameAnalytics.SettingsGA.OrganizationName = EditorGUILayout.TextField(
                        "",
                        GameAnalytics.SettingsGA.OrganizationName,
                        GUILayout.Width(INPUT_WIDTH)
                    );
                    GUILayout.FlexibleSpace();
                    GUILayout.EndHorizontal();
                    ...
                    GameAnalytics.SettingsGA.OrganizationIdentifier = EditorGUILayout.TextField(
                        "",
                        GameAnalytics.SettingsGA.OrganizationIdentifier,
                        GUILayout.Width(INPUT_WIDTH)
                    );
                    GUILayout.FlexibleSpace();
                    GUILayout.EndHorizontal();
                ...
                case 1: // add your game
                    ...
                    GUILayout.FlexibleSpace();
                    GUILayout.Label(
                        GameAnalytics.SettingsGA.GameIcon,
                        new GUILayoutOption[] { GUILayout.Width(40), GUILayout.MaxHeight(40) }
                    );
                    GUILayout.FlexibleSpace();
                    GUILayout.EndHorizontal();
                    ...
                    GameAnalytics.SettingsGA.GameName = EditorGUILayout.TextField(
                        "",
                        GameAnalytics.SettingsGA.GameName,
                        new GUILayoutOption[] { GUILayout.Width(300), GUILayout.Height(30) }
                    );
                    ...
                    if (
                        GUILayout.Button(
                            "Find your game",
                            new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxHeight(30) }
                        )
                    )
                    {
                    ...
                    if (_appFiguresGames != null && _appFiguresGames.Count > 0)
                    {
                        ...
                        GUILayout.FlexibleSpace();
                        GUILayout.Label(
                            "'" + _appFigName + "' matched " + _appFiguresGames.Count + " titles.",
                            EditorStyles.boldLabel
                        );
                        GUILayout.FlexibleSpace();
                        GUILayout.EndHorizontal();
                        ...
                        GUILayout.BeginHorizontal();
                        GUILayout.FlexibleSpace();
                        _appScrollPos = GUILayout.BeginScrollView(
                            _appScrollPos,
                            GUI.skin.box,
                            GUILayout.Width(571)
                        );
                    ...
                    if (
                        GUILayout.Button(
                            "Create new game",
                            new GUILayoutOption[] { GUILayout.Width(200), GUILayout.Height(30) }
                        )
                    )
                    {
                        TourStep = 2;
                ...
                case 2: // create new game
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.FlexibleSpace();
                    this._selectedOrganization = EditorGUILayout.Popup(
                        "",
                        this._selectedOrganization,
                        Organization.GetOrganizationNames(
                            GameAnalytics.SettingsGA.Organizations,
                            false
                        ),
                        GUILayout.Width(200)
                    );
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.FlexibleSpace();
                    this._selectedStudio = EditorGUILayout.Popup(
                        "",
                        this._selectedStudio,
                        this._selectedOrganization > 0
                            ? Studio.GetStudioNames(
                                GameAnalytics.SettingsGA.Organizations[
                                    this._selectedOrganization - 1
                                ].Studios,
                                false
                            )
                            : new string[0],
                    ...
                    GameAnalyticsSDK.Setup.Settings settings =
                        CreateInstance<GameAnalyticsSDK.Setup.Settings>();
                    this._selectedPlatform = (RuntimePlatform)
                        EditorGUILayout.Popup(
                            "",
                            (int)this._selectedPlatform,
                            settings.GetAvailablePlatforms(),
                            GUILayout.Width(200)
                        );
                    GUILayout.FlexibleSpace();
                    GUILayout.EndHorizontal();
                ...
                case 3: // app figures add game
                    ...
                    {
                        GUILayout.Label(
                            _appFiguresGame.Icon,
                            new GUILayoutOption[] { GUILayout.Width(100), GUILayout.Height(100) }
                        );
                    }
                    else
                    {
                ...
                case 14:
                    ...
                    GUILayout.FlexibleSpace();
                    GUILayout.Label(
                        GameAnalytics.SettingsGA.InstrumentIcon,
                        new GUILayoutOption[] { GUILayout.Width(40), GUILayout.Height(40) }
                    );
                    GUILayout.FlexibleSpace();
                    GUILayout.EndHorizontal();
                    ...
                    GUILayout.FlexibleSpace();
                    GUILayout.Label(
                        "Let us guide you through getting properly setup with GameAnalytics."
                    );
                    GUILayout.FlexibleSpace();
                    GUILayout.EndHorizontal();
            ...
            switch (step)
            {
                case 1:
                    return new StringWithType[]
                    {
                        ...
                        new StringWithType
                        {
                            ...
                            Link =
                                "https://github.com/GameAnalytics/GA-SDK-UNITY/wiki/Settings#setup"
                        },
                    };
                case 2:
                    return new StringWithType[]
                    {
                        ...
                        {
                            Text =
                                "Click here to learn more about the full list of core metrics and dimensions.",
                            Type = StringType.Link,
                            Link =
                                "http://www.gameanalytics.com/docs/metric-and-dimensions-reference/"
                        }
                    };
                case 3:
                    return new StringWithType[]
                ...
                case 4:
                    return new StringWithType[]
                    {
                        ...
                        new StringWithType
                        {
                            Text = "To add a business event call the following function:"
                        },
                        new StringWithType
                        {
                            Text =
                        ...
                        {
                            Text =
                                "Click here to learn more about the Business event and purchase validation.",
                            Type = StringType.Link,
                            Link =
                ...
                case 5:
                    return new StringWithType[]
                    {
                        ...
                        new StringWithType
                        {
                            Text = "To add a resource event call the following function:"
                        },
                        new StringWithType
                        {
                            Text =
                        ...
                        new StringWithType
                        {
                            ...
                            Type = StringType.Link,
                            Link =
                                "https://github.com/GameAnalytics/GA-SDK-UNITY/wiki/Resource%20Event"
                        }
                    };
                case 6:
                    return new StringWithType[]
                    {
                        ...
                        new StringWithType
                        {
                            Text = "To add a progression event call the following function:"
                        },
                        new StringWithType
                        {
                            Text =
                        ...
                        new StringWithType
                        {
                            ...
                            Type = StringType.Link,
                            Link =
                                "https://github.com/GameAnalytics/GA-SDK-UNITY/wiki/Progression%20Event"
                        }
                    };
                case 7:
                    return new StringWithType[]
                    {
                        ...
                        new StringWithType
                        {
                            Text = "To add a design event call the following function:"
                        },
                        new StringWithType
                        {
                            Text =
                        ...
                        new StringWithType
                        {
                            ...
                            Type = StringType.Link,
                            Link =
                                "https://github.com/GameAnalytics/GA-SDK-UNITY/wiki/Design%20Event"
                        }
                    };
                case 8:
                    return new StringWithType[]
                    {
                        ...
                        new StringWithType
                        {
                            Text = "To add a custom error event call the following function:"
                        },
                        new StringWithType
                        {
                            Text =
                                "GameAnalytics.NewErrorEvent (GA_Error.GAErrorSeverity severity, string message);",
                            Type = StringType.TextBox
                        },
                        new StringWithType { Text = "" },
                        new StringWithType
                        {
                            ...
                            Type = StringType.Link,
                            Link =
                                "https://github.com/GameAnalytics/GA-SDK-UNITY/wiki/Error%20Event"
                        }
                    };
                case 9:
                    return new StringWithType[]
                    {
                        ...
                        new StringWithType
                        {
                            ...
                            Type = StringType.Link,
                            Link =
                                "https://github.com/GameAnalytics/GA-SDK-UNITY/wiki/Set%20Custom%20Dimension"
                        }
                    };
                case 10:
                    return new StringWithType[]
                    {
                        ...
                        {
                            Text =
                                "The Unity SDK includes support for Windows, Mac, Linux, WebGL, iOS, tvOS, UWP, Tizen, Universal Windows 8 and Android.",
                            Type = StringType.Link,
                            Link = "https://github.com/GameAnalytics/GA-SDK-UNITY"
                        },

#endif
                    };
                default:
                    return new StringWithType[] { new StringWithType { Text = "-" } };
            }
        }
            ...
            switch (storeName)
            {
                case "amazon_appstore":
                    if (GameAnalytics.SettingsGA.AmazonIcon != null)
                    {
                        ...
                        GUILayout.Label(
                            ...
                            new GUILayoutOption[] { GUILayout.Width(20), GUILayout.MaxHeight(20) }
                        );
                    }
                ...
                case "apple":
                    if (GameAnalytics.SettingsGA.iosIcon != null)
                    {
                        //GUILayout.Label("", GUILayout.Height(-20));
                        GUILayout.Label(
                            GameAnalytics.SettingsGA.iosIcon,
                            new GUILayoutOption[] { GUILayout.Width(20), GUILayout.MaxHeight(20) }
                        );
                    }
                ...
                case "apple:mac":
                    if (GameAnalytics.SettingsGA.macIcon != null)
                    {
                        //GUILayout.Label("", GUILayout.Height(-20));
                        GUILayout.Label(
                            GameAnalytics.SettingsGA.macIcon,
                            new GUILayoutOption[] { GUILayout.Width(20), GUILayout.MaxHeight(20) }
                        );
                    }
...
#if UNITY_2017_1_OR_NEWER
        public IEnumerator GetAppStoreIconTexture(
            UnityWebRequest www,
            string storeName,
            GA_SignUp signup
        )
...
#if UNITY_2017_1_OR_NEWER
                            GameAnalytics.SettingsGA.AmazonIcon = (
                                (DownloadHandlerTexture)www.downloadHandler
                            ).texture;
#else
                            GameAnalytics
                                .SettingsGA
                                .AmazonIcon = www.texture;
#endif
                            break;
                        case "google_play":
#if UNITY_2017_1_OR_NEWER
