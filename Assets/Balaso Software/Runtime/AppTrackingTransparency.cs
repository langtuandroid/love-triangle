...
namespace Balaso
{
    ...
    {   
        ...
        {
            ACLogger.UserDebug(string.Format("UnityAppTrackingTransparencyCallback received: {0}", result));
        ...
        public static AuthorizationStatus TrackingAuthorizationStatus
        {
            ...
            {
#if UNITY_EDITOR
                ACLogger.UserDebug("Running on Editor platform. Callback invoked with debug result");
        ...
        public static void UpdateConversionValue(int value)
        {
            ...
            {
                ACLogger.UserDebug(string.Format("Updating conversion value to {0}", value));
                updateConversionValue(value);
            }
            else
            {
                ACLogger.UserDebug(string.Format("Platform '{0}' not supported", Application.platform));
            }
#endif
        }
